...
**Homepage:** <https://github.com/opencomputinggarage/snowflake-exporter>
...
```console
crane ls ghcr.io/opencomputinggarage/charts/snowflake-exporter
```
...
```console
helm install snowflake-exporter oci://ghcr.io/opencomputinggarage/charts/snowflake-exporter
```

Install with custom values:

```console
helm install snowflake-exporter oci://ghcr.io/opencomputinggarage/charts/snowflake-exporter -f values.yaml
```

Install a specific version:

```console
helm install snowflake-exporter oci://ghcr.io/opencomputinggarage/charts/snowflake-exporter --version 0.1.0
```
...
```console
helm pull oci://ghcr.io/opencomputinggarage/charts/snowflake-exporter --untar --version 0.1.0
...
```console
helm upgrade snowflake-exporter oci://ghcr.io/opencomputinggarage/charts/snowflake-exporter
```
...
| image.repository | string | `"ghcr.io/opencomputinggarage/snowflake-exporter"` | Container image repository |
...
* <https://github.com/opencomputinggarage/snowflake-exporter>
...
This chart is licensed under the MIT License. See [LICENSE](https://github.com/opencomputinggarage/snowflake-exporter/blob/main/LICENSE) for details.
